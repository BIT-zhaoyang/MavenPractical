...
public class AccountPersistServiceImpl implements AccountPersistService {
	private final String ELEMENT_ROOT = "account_persist";
	...
	public Account createAccount(Account account) throws AccountPersistException {
		...
		accountElement.addElement(ELEMENT_ACCOUNT_ID)
						.setText(account.getId());
		accountElement.addElement(ELEMENT_ACCOUNT_NAME)
						.setText(account.getName());
		accountElement.addElement(ELEMENT_ACCOUNT_EMAIL)
						.setText(account.getEmail());
		accountElement.addElement(ELEMENT_ACCOUNT_PASSWORD)
						.setText(account.getPassword());
		accountElement.addElement(ELEMENT_ACCOUNT_ACTIVATED)
						.setText(account.isActivated() ? "true" : "false");
	...
	public Account updateAccount(Account account) throws AccountPersistException {
		...
		for(Element accountEle : (List<Element>) accountsEle.elements()) {
			if(accountEle.elementText(ELEMENT_ACCOUNT_ID).equals(account.getId())) {
				accountEle.element(ELEMENT_ACCOUNT_NAME)
					.setText(account.getName());
				accountEle.element(ELEMENT_ACCOUNT_EMAIL)
					.setText(account.getEmail());
				accountEle.element(ELEMENT_ACCOUNT_PASSWORD)
					.setText(account.getPassword());
				accountEle.element(ELEMENT_ACCOUNT_ACTIVATED)
					.setText(account.isActivated() ? "true" : "false");
				break;
			}
		}
	...
	private Account buildAccount(Element element) {
		...
		account.setActivated(("true".equals(
				element.elementText(ELEMENT_ACCOUNT_ACTIVATED))? true:false));
